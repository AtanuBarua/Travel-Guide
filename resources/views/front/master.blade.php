...
<!-- Page-->
{{--<div class="page"><a class="section section-banner text-center d-none d-xl-block" href="https://www.templatemonster.com/intense-multipurpose-html-template.html" style="background-image: url({{asset('/')}}front/images/banner/background-04-1920x60.jpg); background-image: -webkit-image-set( url({{asset('/')}}front/images/banner/background-04-1920x60.jpg) 1x, url({{asset('/')}}front/images/banner/background-04-3840x120.jpg) 2x )"><img src="{{asset('/')}}front/images/banner/foreground-04-1600x60.png" srcset="{{asset('/')}}front/images/banner/foreground-04-1600x60.png 1x, {{asset('/')}}front/images/banner/foreground-04-3200x120.png 2x" alt="" width="1600" height="310"></a>--}}
    <!-- Page Header-->
            ...
            <nav class="rd-navbar" data-layout="rd-navbar-fixed" data-sm-layout="rd-navbar-fixed" data-md-layout="rd-navbar-fixed" data-md-device-layout="rd-navbar-fixed" data-lg-layout="rd-navbar-fullwidth" data-xl-layout="rd-navbar-static" data-lg-device-layout="rd-navbar-fixed" data-xl-device-layout="rd-navbar-static" data-md-stick-up-offset="130px" data-lg-stick-up-offset="100px" data-stick-up="true" data-sm-stick-up="true" data-md-stick-up="true" data-lg-stick-up="true" data-xl-stick-up="true">
                ...
                <div class="rd-navbar-inner">
                    ...
                    <div class="rd-navbar-panel">
                        ...
                        <!-- RD Navbar Brand-->
                        <div class="rd-navbar-brand"><a class="brand-name" href="index.html"><img class="logo-default" src="{{asset('/')}}front/images/logo-default-208x46.png" alt="" width="208" height="46"/><img class="logo-inverse" src="{{asset('/')}}front/images/logo-inverse-208x46.png" alt="" width="208" height="46"/></a></div>
                    </div>
...
{{--    </section><a class="section section-banner" href="https://www.templatemonster.com/intense-multipurpose-html-template.html" style="background-image: url({{asset('/')}}front/images/banner/background-03-1920x310.jpg); background-image: -webkit-image-set( url({{asset('/')}}front/images/banner/background-03-1920x310.jpg) 1x, url({{asset('/')}}front/images/banner/background-03-3840x620.jpg) 2x )"><img src="{{asset('/')}}front/images/banner/foreground-03-1600x310.png" srcset="{{asset('/')}}front/images/banner/foreground-03-1600x310.png 1x, {{asset('/')}}front/images/banner/foreground-03-3200x620.png 2x" alt="" width="1600" height="310"></a>--}}

    <!-- Footer Minimal-->
    <footer class="section page-footer page-footer-minimal novi-background bg-cover text-center bg-gray-darker">
        <div class="container container-wide">
            <div class="row row-fix justify-content-sm-center align-items-md-center row-30">
                <div class="col-md-10 col-lg-7 col-xl-4 text-xl-left"><a href="index.html"><img class="inverse-logo" src="{{asset('/')}}front/images/logo-inverse-208x46.png" alt="" width="208" height="46"/></a></div>
